...
@section('title', 'Data Guru Approve')

@section('content')
    <div class="row">
        <div class="col-md-12">
            <!-- DATA TABLE -->
            <h3 class="title-5 m-b-35">data guru approve</h3>
                        ...
                        <tr class="tr-shadow">
                            ...
                            <td>
                                <div class="table-data-feature">
                                    ...
                                    <a href="/dataGuru/trash/{{ $q->id_guru }}" class="item" data-toggle="tooltip" data-placement="top"
                                        title="Trash">
                                        <i class="zmdi zmdi-delete"></i>
                                    </a>
                                </div>
